...
- للإدارة: ادخل ببريد `admin@dandouna.local`.

> **⚠ حاسم للإطلاق:** الدخول يعتمد على رمز OTP بالبريد. **بدون `RESEND_API_KEY`
> لن يستطيع المستخدمون الدخول في الإنتاج** (الرمز يُطبع في السجل في التطوير فقط).
> تفعيل Resend شرطٌ للإطلاق الرسمي.
